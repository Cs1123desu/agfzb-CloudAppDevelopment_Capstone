...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://charles22394-3000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://charles22394-3000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
        context["dealer"] = dealer

        review_url = "https://charles22394-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews"
...
def add_review(request, id):
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            review_post_url = "https://charles22394-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/post_review"
